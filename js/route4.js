$(function () {
    ...
    function createTable(arr) {
        ...
        for (var i = 0; i < col.length; i++) {
            ...
            th.innerHTML = `<th scope="col"><button type="button" style="text-transform: capitalize;border-color: #ffff;font-weight: bold;" id="headerbtn-${i}" class="btn">${col[i]}</button></th>`
